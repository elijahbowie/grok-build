/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=remote/wrangler.jsonc remote/worker-configuration.d.ts` (hash: 27798e6f2dec3d3b8fd01be00f371a12)
// Runtime types generated with workerd@1.20260710.1 2026-07-16 nodejs_compat
interface __BaseEnv_Env {
	GROK_HOME_STORE: R2Bucket;
	EVIDENCE_BUCKET: R2Bucket;
	BACKUP_BUCKET: R2Bucket;
	CONNECTOR_SECRETS: R2Bucket;
	...
	ARTIFACTS_NAMESPACE: "grok-build";
	PUBLIC_ORIGIN: "https://grok.forgeagent.app";
	MACHINE_ORIGIN: "https://grok-build-runner.director-78b.workers.dev";
	CLOUDFLARE_ACCOUNT_ID: "78b5cd80a13b55be136c10cb30e4012e";
	BACKUP_BUCKET_NAME: "grok-build-backups-director-78b";
	TASK_RETENTION_DAYS: "30";
	MAX_CONCURRENT_TASKS: "5";
	TASK_TIMEOUT_MINUTES: "60";
	STANDARD_3_COST_PER_HOUR_MICROS: "220032";
	RUNNER_TOKEN: string;
	Sandbox: DurableObjectNamespace<import("./src/index").Sandbox>;
	TASK_HUB: DurableObjectNamespace<import("./src/index").TaskHub>;
	TASK_WORKFLOW: Workflow<Parameters<import("./src/index").TaskWorkflow['run']>[0]['payload']>;
	GITHUB_SYNC_WORKFLOW: Workflow<Parameters<import("./src/index").GitHubSyncWorkflow['run']>[0]['payload']>;
	REVIEW_WORKFLOW: Workflow<Parameters<import("./src/index").ReviewWorkflow['run']>[0]['payload']>;
	PLAN_WORKFLOW: Workflow<Parameters<import("./src/index").PlanningWorkflow['run']>[0]['payload']>;
	DESIGN_WORKFLOW: Workflow<Parameters<import("./src/index").DesignWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "Sandbox" | "TaskHub";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AUTH_EMAIL" | "AUTH_SUB" | "ARTIFACTS_NAMESPACE" | "PUBLIC_ORIGIN" | "MACHINE_ORIGIN" | "CLOUDFLARE_ACCOUNT_ID" | "BACKUP_BUCKET_NAME" | "TASK_RETENTION_DAYS" | "MAX_CONCURRENT_TASKS" | "TASK_TIMEOUT_MINUTES" | "STANDARD_3_COST_PER_HOUR_MICROS" | "RUNNER_TOKEN">> {}
}
